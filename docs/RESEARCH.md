...
- **UNKNOWN:** Establishing `MODE_IN_COMMUNICATION` after early track playback but before assistant/speech may or may not reduce clipping without destabilizing recognition; physical execution of D-037 is required.
