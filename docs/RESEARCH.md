...
- **UNKNOWN:** The observed ordering does not prove cleanup caused the failed later Gemini turn. Five-turn Gemini and ChatGPT physical runs with the 5-second linger, plus unchanged browser and immediate-cleanup checks, are required before assessing the hypothesis.
