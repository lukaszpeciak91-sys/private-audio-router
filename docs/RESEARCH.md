...
- Whether the permission-corrected POC-5 places Private Audio in the mode-owner stack, makes it the actual mode owner, changes the computed/applied route to the built-in earpiece, and makes ChatGPT audio audibly use the earpiece.
