...
- The six new user-facing attachment strings are present in every supported locale resource tree and participate in the normal key/placeholder parity contract; the temporary MissingTranslation suppression and fallback-allowlist entries used during initial implementation have been removed.
