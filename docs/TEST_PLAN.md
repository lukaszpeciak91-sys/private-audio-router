...
- **Evidence rule:** Automated tests establish code contracts only. Record Android-reported timing and human-observed first-response clipping separately; improvement and OEM behavior remain **UNKNOWN** until physical execution.
